...
export const seedData = () => {
    ...
    const organizations = [
        { id: 'org-1', name: 'ChiHealth General Hospital', type: 'Hospital', planId: 'professional' },
        { id: 'org-2', name: 'ChiHealth Clinic Ikoyi', type: 'Clinic', planId: 'professional', parentOrganizationId: 'org-1' },
    ];
    const departments = [
