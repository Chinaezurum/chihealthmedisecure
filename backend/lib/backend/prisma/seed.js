...
export const seedData = () => {
    ...
    const users = [
        ...
        // Staff
        { id: 'user-admin-01', name: 'Admin User', email: 'admin@chihealth.com', role: 'admin', passwordHash: password, organizations: [organizations[0], organizations[1]], currentOrganization: organizations[0] },
        { id: 'user-admin-enterprise', name: 'Enterprise Admin', email: 'enterprise@chihealth.com', role: 'admin', passwordHash: password, organizations: [organizations[2]], currentOrganization: organizations[2] },
        { id: 'user-cmd-01', name: 'Command Center', email: 'cmd@chihealth.com', role: 'command_center', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0] },
        { id: 'user-hcw-01', name: 'Dr. Adebayo', email: 'dr.adebayo@chihealth.com', role: 'hcw', passwordHash: password, organizations: [organizations[0], organizations[1]], currentOrganization: organizations[0], departmentIds: ['dept-1', 'dept-3'] },
        { id: 'user-nurse-01', name: 'Nurse Joy', email: 'nurse.joy@chihealth.com', role: 'nurse', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0], departmentIds: ['dept-3'] },
        { id: 'user-pharma-01', name: 'Pharmacist Ken', email: 'pharma.ken@chihealth.com', role: 'pharmacist', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0] },
        ...
        { id: 'user-dietician-01', name: 'Dietician Grace', email: 'dietician@chihealth.com', role: 'dietician', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0], departmentIds: ['dept-3'] },
        { id: 'user-radiologist-01', name: 'Dr. Ray Chen', email: 'radiologist@chihealth.com', role: 'radiologist', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0], departmentIds: ['dept-1'] },
        { id: 'user-it-01', name: 'IT Support Admin', email: 'it@chihealth.com', role: 'it_support', passwordHash: password, organizations: [organizations[0]], currentOrganization: organizations[0] },
    ...
    const rooms = [
        { id: 'room-1', name: 'Consulting Room 1', type: 'Consulting Room', organizationId: 'org-1' },
        { id: 'room-2', name: 'Consulting Room 2', type: 'Consulting Room', organizationId: 'org-1' },
        { id: 'room-3', name: 'Room 301', type: 'Patient Room', organizationId: 'org-1' },
        { id: 'room-4', name: 'Room 302', type: 'Patient Room', organizationId: 'org-1' },
        { id: 'room-5', name: 'Operating Theater A', type: 'Operating Theater', organizationId: 'org-1' },
    ];
    const appointments = [
        { id: 'appt-001', patientId: 'user-patient-01', doctorId: 'user-hcw-01', doctorName: 'Dr. Adebayo', date: today, time: '10:00', specialty: 'General Checkup', status: 'Confirmed', consultingRoomId: 'room-1', consultingRoomName: 'Consulting Room 1' },
        { id: 'appt-002', patientId: 'user-patient-02', doctorId: 'user-hcw-01', doctorName: 'Dr. Adebayo', date: today, time: '11:30', specialty: 'Follow-up', status: 'Confirmed', consultingRoomId: 'room-2', consultingRoomName: 'Consulting Room 2' },
        { id: 'appt-003', patientId: 'user-patient-01', doctorId: 'user-hcw-02', doctorName: 'Dr. Okoro', date: yesterday, time: '15:00', specialty: 'Dermatology', status: 'Completed', consultingRoomId: 'room-1', consultingRoomName: 'Consulting Room 1' },
    ];
    const prescriptions = [
        { id: 'rx-001', patientId: 'user-patient-01', prescriberId: 'user-hcw-01', medication: 'Lisinopril', dosage: '10mg', frequency: 'Once daily', startDate: '2023-01-15', status: 'Active' },
        { id: 'rx-002', patientId: 'user-patient-01', prescriberId: 'user-hcw-01', medication: 'Potassium Chloride', dosage: '20mEq', frequency: 'Once daily', startDate: '2023-01-15', status: 'Active' },
    ];
    const labTests = [
        { id: 'lab-001', patientId: 'user-patient-01', patientName: 'Amina Bello', orderedById: 'user-hcw-01', testName: 'Complete Blood Count (CBC)', dateOrdered: yesterday, result: 'WBC 5.4, RBC 4.5, HGB 14.1', status: 'Completed' },
        { id: 'lab-002', patientId: 'user-patient-02', patientName: 'Chinedu Eze', orderedById: 'user-hcw-01', testName: 'Basic Metabolic Panel (BMP)', dateOrdered: today, status: 'Ordered' },
    ];
    const clinicalNotes = [
