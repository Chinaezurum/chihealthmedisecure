...
export const validateBillingCode = [
    body('code')
...
export const validateLabSample = [
    body('status')
...
export const validateWearableData = [
    body('heartRate')
        .optional()
...
export const validateIncomingReferral = [
    body('patientName')
